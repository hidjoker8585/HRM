...
public class TableRenderer implements TableCellRenderer{
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		if (value == null) {
			...
			if (isSelected) {
				btn.setBorder(BorderFactory.createMatteBorder(4, 10, 4, 10, table.getSelectionBackground()));
			} else {
				btn.setBorder(BorderFactory.createMatteBorder(4, 10, 4, 10, table.getBackground()));
			}
			return btn;
